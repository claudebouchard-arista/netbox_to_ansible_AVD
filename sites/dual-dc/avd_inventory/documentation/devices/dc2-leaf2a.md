...
| Ethernet6 | P2P_dc1-leaf2a_Ethernet6 | - | 172.16.255.1/31 | default | 9214 | False | - | - |
...
| 172.16.255.0 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65202
   ...
   neighbor 172.16.255.0 remote-as 65102
   neighbor 172.16.255.0 description dc1-leaf2a
